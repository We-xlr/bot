...
func Check(user int) (*types.CheckResponse, error) {
	var url string = "https://gban-api-production.up.railway.app/user"
...
func Ban(user, enforcer int, reason, admin_token string) {
	var url string = "https://gban-api-production.up.railway.app/ban"
...
func Unban(user int) {
	...
	var url string = "https://gban-api-production.up.railway.app/unban"
